...
frappe.ui.form.on('Antrean BPJS',{
	refresh: function(frm) {
		if (frm.is_new()) {
			...
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 1,status_hit: 'Belum di Hit',task_name:'mulai waktu tunggu admisi'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 2,status_hit: 'Belum di Hit',task_name:'akhir waktu tunggu admisi/mulai waktu layan admisi'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 3,status_hit: 'Belum di Hit',task_name:'akhir waktu layan admisi/mulai waktu tunggu poli'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 4,status_hit: 'Belum di Hit',task_name:'akhir waktu tunggu poli/mulai waktu layan poli'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 5,status_hit: 'Belum di Hit',task_name:'akhir waktu layan poli/mulai waktu tunggu farmasi'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 6,status_hit: 'Belum di Hit',task_name:'akhir waktu tunggu farmasi/mulai waktu layan farmasi membuat obat'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 7,status_hit: 'Belum di Hit',task_name:'akhir waktu obat selesai dibuat'});
			// frm.add_child('task_list', {kode_booking:kode_booking,task_id: 99,status_hit: 'Belum di Hit',task_name:'tidak hadir/batal'});
			...
			frappe.call('antrean.aplikasi_antrean_sistem_informasi_rumah_sakit.antrean.send', {
	...
	before_save:function(frm){
		...
		if (frm.is_new()) {
			...
			frappe.call({
				method: 'antrean.aplikasi_antrean_sistem_informasi_rumah_sakit.antrean.send',
				args: {
					service: 'antrean/add',
					method: 'POST',
					payload:payload
	...
	tanggalperiksa:function(frm){
		...
		frappe.call({
			method: 'antrean.aplikasi_antrean_sistem_informasi_rumah_sakit.vclaim.send',
			args: {
